export default function ListenPage() {
  return (
    <section className="container-padded py-14 md:py-20">
      <h1 className="hero-title text-3xl md:text-5xl font-semibold tracking-tight">Listen</h1>
      <p className="mt-6 max-w-2xl text-sm md:text-base text-foreground/85">
        Add embeds or links to recordings here. For example, YouTube, Spotify, or
        self-hosted audio.
      </p>
